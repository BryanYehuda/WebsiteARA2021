                        ...
                        <div class="content-designed">
                          <div class="row">
                            <div class="col s12 center-align"><br>
                              <span class="form-title-designed"><strong>Tata Cara Pendaftaran Webinar IoT</strong></span>
                            </div>
                          </div>
                          <div class="row">
                          ...
                          <div class="register-webinar">
                            <div class="row"><br>
                              <div class="col s12 center-align">
                                <span class="form-title-designed "><strong>Form Registrasi Webinar IoT ARA 2021</strong></span>
                                <br>
                              </div>
                              <div class="row">
                                <form id="form" name="form" class=" col s12" action="<?php echo base_url().'daftar/webinar' ?>" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="row">
                                      <div class="col s12 l12">
                                        <span class="form-title-designed">Follow Instagram Telkomsel</span>
                                      </div>
                                    </div>

                                    <div class="row">
                                      <div class="col s12 l12">
                                        <span class="form-input-title-designed">Instagram Telkomsel bisa dilihat di
                                          <a href="#">sini</a></span>
                                        </div>
                                      </div>
                                      <div class="row">
                                        <div class="col s12 l6">
                                          <span class="form-input-title-designed">Bukti Follow Instagram Telkomsel:
                                            <span class="required-star-designed">*</span></span>
                                        </div>
                                        <div class="col s12 l6">
                                          <div class="file-field input-field">
                                      ...
                                      <div class="row">
                                        <div class="col s12 l12">
                                          <span class="form-title-designed">Follow Instagram PAMA Persada</span>
                                        </div>
                                      </div>

                                      <div class="row">
                                        <div class="col s12 l12">
                                          <span class="form-input-title-designed">Instagram PAMA Persada bisa dilihat di
                                          <a href="#">sini</a></span>
                                        </div>
                                      </div>
                                      ...
                                      <div class="row">
                                        <div class="col s12 l6">
                                          <span class="form-input-title-designed">Bukti Follow Instagram PAMA Persada:
                                            <span class="required-star-designed">*</span></span>
                                        </div>
                                        <div class="col s12 l6">
                                          <div class="file-field input-field">
                                      ...
                                      <div class="row">
                                        <div class="col s12 l12">
                                          <span class="form-title-designed">Upload TWIBBON ARA 2021 di Instagram anda</span>
                                        </div>
                                      </div>

                                      <div class="row">
                                        <div class="col s12 l12">
                                          <span class="form-input-title-designed">TWIBBON ARA 2021 bisa didownload di
                                          <a href="#">sini</a></span>
                                        </div>
                                      </div>
                                      ...
                                      <div class="row">
                                        <div class="col s12 l6">
                                          <span class="form-input-title-designed">Bukti Upload TWIBBON ARA 2021:
                                        </div>
                                        <div class="col s12 l6">
                                          <div class="file-field input-field">
                                            <div class="btn upload-button-designed">
