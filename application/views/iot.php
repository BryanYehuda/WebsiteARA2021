                      ...
                      <div class="content-designed">
                        <div class="row">
                          <div class="col s12 center-align"><br>
                            <span class="form-title-designed"><strong>Tata Cara Pendaftaran Internet of Things</strong></span>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col s12" style="text-align:justify">
                            ...
                            2. Alda : aldaharjian. (line) / 087858008708</p>
                          </div>  
                        </div>
                      </div>
                      <br><br>
                        ...
                        <div class="register-webinar">
                          <div class="row"><br>
                            <div class="col s12 center-align">
                              <span class="form-title-designed "><strong>Form Registrasi Ide Inovatif IoT ARA 2021</strong></span>
                              <br>
                            </div>
                            <div class="row">
                              <form id="form" name="form" class="col s12" action="<?php echo base_url().'daftar/iot' ?>" method="post" enctype="multipart/form-data">
                                <br><br>
                                <div class="row">
                                ...
                                <div class="col s4 l4">
                                    <input class="form-input-designed" id="jurusan_kedua" name="jurusan2" class="validate"
                                        ...
                                        <div class="col s12 l6">
                                          <div class="file-field input-field">
                                            <div class="btn upload-button-designed">
                                              ...
                                              onchange="return fileValidation('surat1')" required>
                                              <label for="surat1">
                                                <img class="upload-button-image-designed"
                                                src="<?php echo base_url('assets/images/upload_black.png') ?>"
                                                style="max-height: 90%;">
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="row">
                                          <div class="col s12 l6">
                                            <span class="form-input-title-designed">Bukti Share Poster IoT ARA 2021:
                                          ...
                                          <div class="row">
                                            <div class="center-align">
                                              <br><br>
                                              <button class="btn waves-effect waves-light center-align submit-button-form-designed" type="submit" name="action" style="background-color: #64a0cc;">Daftar</button>
                                            </div>
                                          </div>
                                        </form>
                                      </div>
