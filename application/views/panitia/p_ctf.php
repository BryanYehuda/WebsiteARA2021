            ...
            <div class="modal-content" style="background-color: rgb(56, 56, 56);">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <br>
                        <a href="<?php echo base_url('uploads/ctf/') . $data->nama_tim . '/ktm/' . $data->ktm1; ?>"
                        ...
                        <br>
                        <a href="<?php echo base_url('uploads/ctf/') . $data->nama_tim . '/surat/' . $data->surat1; ?>"
                            draggable="false" target="_blank">
            ...
            <div class="modal-content" style="background-color: rgb(56, 56, 56);">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <br>
                        <a href="<?php echo base_url('uploads/ctf/') . $data->nama_tim . '/ktm/' . $data->ktm2; ?>"
                            draggable="false" target="_blank">
                            <?=$data->ktm2; ?>
                        </a>
                        <br>
                        ...
                        <br>
                        <a href="<?php echo base_url('uploads/ctf/') . $data->nama_tim . '/surat/' . $data->surat2; ?>"
                            draggable="false" target="_blank">
            ...
            <div class="modal-content" style="background-color: rgb(56, 56, 56);">
                ...
                <div class="modal-body">
                    <p>
                        ...
                        <br>
                        <a href="<?php echo base_url('uploads/ctf/') . $data->nama_tim . '/ktm/' . $data->ktm3; ?>"
                            draggable="false" target="_blank">
                            <?=$data->ktm3; ?>
                        </a>
                        <br>
                        ...
                        <br>
                        <a href="<?php echo base_url('uploads/ctf/') . $data->nama_tim . '/surat/' . $data->surat3; ?>"
                            draggable="false" target="_blank">
