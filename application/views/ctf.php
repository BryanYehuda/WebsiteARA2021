                        ...
                        <div class="content-designed">
                          <div class="row">
                            <div class="col s12 center-align"><br>
                              <span class="form-title-designed"><strong>Tata Cara Pendaftaran Capture the Flag</strong></span>
                            </div>
                          </div>
                          <div class="row">
                          ...
                          <div class="register-webinar">
                            <div class="row"><br>
                              <div class="col s12 center-align">
                                <span class="form-title-designed "><strong>Form Registrasi Capture The Flag ARA 2021</strong></span>
                                <br>
                              </div>
                              <div class="row">
                                <form id="form" name="form" class="col s12" action="<?php echo base_url().'daftar/ctf' ?>" method="post"  enctype="multipart/form-data">
                                  <br><br>
                                  <div class="row">
                                  ...
                                  <div class="col s4 l4">
                                      <input class="form-input-designed" id="jurusan_kedua" name="jurusan2" class="validate"
                                        ...
                                        <div class="row">
                                          <div class="col s12 l12">
                                            <span class="form-title-designed">Share Poster CTF ARA 2021 di Instastory (maksimum file size 2MB)</span>
                                          </div>
                                        </div>
                                        <div class="row">
                                          <div class="col s12 l12">
