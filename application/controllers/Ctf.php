...
class Ctf extends CI_Controller {
	...
	public function index(){
		...
		$detil_tim = $this->m_data->get_where("ctf",array('nama_tim' => $info_tim['nama']))->row_array();
		...
		$this->load->view('dashboardCtf/dashboardCtf', $data);
