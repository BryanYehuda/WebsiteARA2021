...
-Icon masih bermasalah (DONE, dikerjakan oleh Rangga -> Icon Event DONE, Timeline DONE, ICON Pendaftaran DONE, ICON Sukses Done) (Pengerjaan FrontEND oleh Bryan -> DONE, menunggu ICON Pendaftaran):white_check_mark:
- Button nggak ada padding (DONE, dikerjakan oleh Bryan):white_check_mark:
- Animasi Lompat-lompat gaperlu (IGNORED, nanti akan diganti animasi yang lebih keren biar terasa lebih live) :x:
- Scrollbar diedit biar gak polosan (NEXT JOBDESK, nanti akan didesign scrollbar yang lebih keren) :clock12:
- Card buat sponsor (NEXT JOBDESK, menunggu list sponsor fix dan logo-logo mereka) :clock12:
...
2. Progres Subdivisi Website dari 8 Januari 2021
...
4. NEXT NEXT JOBDESK :bookmark_tabs: :clock12: 
...
5. Saran dari Divisi Design (24 Januari 2021) 
- nggabung container timeline dan apa itu (DONE, sudah tergabung)
- container pendaftaran gak perlu keterangan langsung syarat dan ketentuan :white_check_mark:
- tombol daftar font kegedean:white_check_mark:
- judul container taruh tengah:white_check_mark:
- navbar belum dikasih border :white_check_mark:
- home pendaftaran font kurang besar :white_check_mark:
- picture frame update yang dikasih border:white_check_mark:
- belum ada CP :white_check_mark:
- form input pendaftaran shadow diganti border <br>(IGNORED, karena jadi lebih jelek ):x:
- font ganti open sans :white_check_mark:
...
Progres sebelumnya 
- Backend Dashboard IoT, CTF, dan Olimpiade :white_check_mark: 
- Update Scrollbar :x: 
- Update Service worker :white_check_mark: 
- Update link ke Gdrive Pendownload Poster dan Twibbon :white_check_mark: 
- Tambahin tulisan max file size 2mb :white_check_mark: 
- Perbaiki caption webinar :white_check_mark: 
- View Dashboard IoT :white_check_mark: 
- Buat Admin page untuk Webinar dan IoT :white_check_mark:
- Bikin desain banner sponsor :white_check_mark: 
- Update Link Grup WA :white_check_mark: 
- Update Batch 3 Pendaftaran :white_check_mark:

Dida :
Backend Dashboard IoT, CTF, dan Olimpiade (15 Februari, DONE)

Bryan :
Update Scrollbar (11 Februari) 
Update link ke Gdrive Pendownload Poster dan Twibbon (9 Februari, DONE) :white_check_mark: 
Tambahin tulisan max file size 2mb (9 Februari, DONE):white_check_mark: 
View Dashboard IoT (11 Februari, DONE):white_check_mark: 

Riris :
Perbaiki caption webinar (9 Februari, DONE):white_check_mark: 

Rafael : 
Buat Admin page untuk Webinar dan IoT (15 Februari, DONE) :white_check_mark:

Ariel : 
Dapat tugas dari Carlo - Admin Publikasi (Continuous):white_check_mark: 
Update Service worker (17 Februari, DONE) :white_check_mark:
...
Pembagian Jobdesk berikutnya :bookmark_tabs: 
1. Update Scrollbar 
...
Rafael : 
Admin Page IOT nampilin KTI yang terupload (bisa didownload dan dilihat admin) (3 Maret, DONE) :white_check_mark:
Update Status Peserta (Menang, Kalah, Lolos, Dsb) (5 Maret, DONE) :white_check_mark: 
Email Brute Force (4 Maret, DONE) :white_check_mark:

Dida :
Upload KTI (memastikan sistem upload KTI nya sudah aman) (4 Maret, DONE) :white_check_mark: 
View setelah KTI Terupload (Disable button untuk upload) (5 Maret, DONE) :white_check_mark:

Ariel : 
Update Service Worker (10 Maret. DONE) :white_check_mark: 
Dokumentasi Readme (7 Maret, DONE) :white_check_mark: 
Belajar Git (7 Maret, DONE) :white_check_mark: 
